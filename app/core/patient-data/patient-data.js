...
angular.module('ianmd.core.patient.data', [])
  .factory('patientData', function(kPatientInputFields, $localStorage, kAppVersion, userService){
    ...
    if (!$localStorage.patientData || $localStorage.patientData.version !== kAppVersion) {
      ...
      patientData['sana.marina'].lifeeventbio.value = 'I grew up on a farm, where I got to ride horses every day, but I moved to the big city in my twenties and haven\'t ridden since. I met the love of  my life at my church, and we were together until he passed away in 2009.  We had two children, and I was there for them as they grew up, instilling  them with the same values and virtues I hold dear - faith and service to community.'
      ...
      patientData['mark.dunn'].gender.value = 'His';
      ...
      patientData['james.smith'].gender.value = 'His';
      ...
      patientData['alex.writer'].gender.value = 'His';
      ...
      patientData['chris.gregory'].gender.value = 'His';
      ...
      patientData['james.red'].gender.value = 'His';
      ...
      patientData['red.green'].gender.value = 'His';
